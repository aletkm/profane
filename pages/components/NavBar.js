...
const NavBar = () => {
  ...
  return (
    <div className="nav-container" data-testid="navbar">
      <Navbar body inverse style={{ backgroundColor: '#121f26', borderColor: '#121f26' }} light expand="md">
        <Container>
            ...
            <Nav className="mr-auto" navbar data-testid="navbar-items">
              ...
              {user && (
                <>
                  ...
                  <NavItem>
                    <RouterLink href="/users/userslist" className="nav-link" testId="navbar-userslist">
                      Data teste
                    </RouterLink>
                  </NavItem>
                  <NavItem>
                    <RouterLink href="/users" className="nav-link" testId="navbar-user">
                      Users List
                    </RouterLink>
                  </NavItem>
                </>
